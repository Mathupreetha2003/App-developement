  ...
  return (
    <div>
      ...
      <div className="w-[100%] flex flex-col items-center justify-center bg-orange-400 text-white p-[5rem] ">
        ...
        <button class="bg-white ml-[10rem] flex items-center mr-[12rem] font-semibold text-orange-500 border py-2 w-[200px] rounded-xl mt-5 justify-center  hover:scale-110 duration-300">
          Become a Member
        </button>
      ...
      {/*<div className="w-[100%]  bg-slate-500 text-white p-[1rem]">
        <h1 className="text-6xl font-serif flex justify-center p-[2rem]">
          Freelance
        </h1>
        <div className="flex gap-36">
          <p className="text-2xl font-mono  text-white p-[1rem] mb-5">
            Product
          ...
          <p className="text-2xl font-mono  text-white p-[1rem]">
            ...
            <ul className="text-lg">Help Center</ul>
          </p>
