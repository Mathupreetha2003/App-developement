  ...
  const handleEmail =(e)=>
    {
      ...
      dispatch(login({email:e.target.value}))
    }
  return (
    <div>
        ...
        <div className="bg-gray-100 flex rounded-2xl shadow-lg max-w-3xl p-5 items-center">
            <div class="sm:w-1/2 px-16">
                ...
                <form class="flex flex-col gap-4">
                  <input class="p-2 mt-8 rounded-xl border " type="text" name="email" onChange={handleEmail} placeholder="Email"></input>
                  <div class="relative">
                  <input class="p-2 rounded-xl border w-full" type="password" name="password" placeholder="Password"></input>
                  </div>
                  <button class="bg-cyan-600 rounded-xl cursor-pointer text-white py-2 hover:scale-110 duration-300" onClick={() => {navigate("/db");
               }}>Login</button>
                </form>
