  ...
  return (
    <div>
      ...
      <div className="">
        ...
        <h1 className="text-5xl font-serif flex items-center">Make Bright Ideas Happen</h1>
        <p className="text-lg p-2 font-mono mt-5 text-white flex items-center">
        Access global talent on the freelancer website trusted by over 1 million businesses worldwide.</p>
       
        <p className="text-lg p-2 font-mono  text-whiteflex items-center ">
        Manage the entire project within Freelancer</p>
       
        <p className="text-lg p-2 mt-5 font-mono  text-white flex items-center ">
        Upgrade your skills for a life time.</p>
        <p className="text-md p-2 mt-5 font-mono mb-12  text-white flex items-center ">
        Great deals only with Us</p>
        <div className="w-[720px] flex justify-between  bg-white rounded-2xl h-20 text-white" placeholder="Search">
          <input className="border-2 w-[90%] text-3xl text-black" type="text" placeholder="search"></input>
          ...
          <div className=" w-full pb-10 flex mt-5 ml-3 bg-gray-100 rounded-xl shadow-slate-400 ">
            <div className="w-full flex flex-col justify-start">
              ...
              <p className="text-lg p-4 font-mono text-purple-950 ml-10">
              Offers are pre-set bundles from freelancers. Browse a huge variety of offers — from as little as £10. 
               The more detail you can give, the more relevant freelancers you’ll attract.
              </p>
              <p className="text-lg p-4 font-mono  text-purple-950 ml-10">
              Our artificial intelligence system does the hard work — matching and contacting the best freelancers for your project.
              ...
              <p className="text-lg p-4 font-mono  text-purple-950 ml-10">
              Offers are an excellent way for clients to test out ideas and build lasting relationships with freelancers.
               If you're happy with the results, request a follow-on project.
              </p>
              <button class="bg-orange-500 ml-[10rem]  font-bold text-white border py-2 w-[200px] rounded-xl mt-5 flex justify-center items-center hover:scale-110 duration-300">
                Get Projects
              </button>
      ...
      <div className="w-[100%]  bg-orange-400 text-white p-[5rem] ">
        <h1 className="text-5xl font-serif flex items-center">Find an Expert for anything in our Website</h1>
        <p className="text-lg p-2 font-mono mt-5 text-white flex items-center">
        Work with curated freelance talent from all over the world.</p>
       
        <p className="text-lg p-2 font-mono  text-whiteflex items-center ">
        Manage the entire project within PeoplePerHour..</p>
       
        <p className="text-lg p-2 mt-5 font-mono  text-white flex items-center ">
        Pay securely with confidence.</p>
        <button class="bg-white ml-[10rem] flex items-center font-semibold text-orange-500 border py-2 w-[200px] rounded-xl mt-5 justify-center  hover:scale-110 duration-300">
                Become a Member
              </button>
              <p className="text-md p-2 mt-5 font-mono  text-white flex items-center ">
        No Upfront payments or hidden fees</p>
      </div>
      <div className="w-[100%]  bg-slate-500 text-white p-[1rem]">
        <h1 className="text-6xl font-serif flex justify-center p-[2rem]">Freelance</h1>
        <div className="flex gap-36">
        <p className="text-2xl font-mono  text-white p-[1rem] mb-5">Product
        <ul className="text-lg">About</ul>
        <ul className="text-lg">Team</ul>
        <ul className="text-lg">Careers</ul>
        </p>
       
       
        <p className="text-2xl font-mono  text-white p-[1rem]">
        Support
        <ul className="text-lg">How it works</ul>
        <ul className="text-lg">Trust&safety</ul>
        <ul className="text-lg">Help Center</ul></p>
       
        <p className="text-2xl  font-mono  text-white p-[1rem]">
        Discover
        <ul className="text-lg">Guides</ul>
        <ul className="text-lg">Stories</ul>
        <ul className="text-lg">News</ul></p>
              <p className="text-2xl font-mono  text-white p-[1rem]">
        Resource
        <ul className="text-lg">StartUpSites</ul>
        <ul className="text-lg">CustomerStories</ul>
        <ul className="text-lg">Articles</ul></p>
              <p className="text-2xl font-mono  text-white p-[1rem]">
        Browse
        <ul className="text-lg">FreelanceService</ul>
        <ul className="text-lg">FreelanceSkills</ul>
        <ul className="text-lg">Freelancing</ul></p>
        </div>
      </div>
    </div>
  );
