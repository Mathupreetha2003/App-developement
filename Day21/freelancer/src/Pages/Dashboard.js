  ...
  return (
    <div>
      ...
      <div className="flex gap-20 pb-10 bg-gray-200 px-20">
        ...
        <div className="bg-white rounded-xl  mt-5 text-gray-500 text-bold text-xl w-[44rem] h-fit p-5">
        <div className="flex gap-4">
          <button onClick={()=>setView1("Reviews")}>Reviews</button>
          <button onClick={()=>setView1("Purchases")}>Purchases</button>
        </div>
        <div className="">
          <div className={`${view1 === "Purchases" ? "block" : "hidden"}`}>
            <Reviews className="bg-slate-600" />
            </div>
            <div className={`${view1 === "Reviews" ? "block" : "hidden"}`}>
            <Purchases />
            </div>
            </div>
          </div>
